...
public class DBManager {
    ...
    public ArrayList<NotiDataDTO> getNotificationList(String query) {
        ...
        ArrayList<NotiDataDTO> result = new ArrayList<>();
        ...
        for(int i=0; i<cursor.getCount(); i++){
            ...
            result.add(new NotiDataDTO(cursor.getInt(0), cursor.getString(1), cursor.getString(5), cursor.getString(2), tmpWeight, cursor.getInt(4) == 1 ? true : false));
            cursor.moveToNext();
        }
        cursor.close();
